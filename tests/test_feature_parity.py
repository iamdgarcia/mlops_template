...
class TestFeatureParity:
    ...
    def sample_raw_data(self):
        ...
        data = {
            ...
            'merchant_category': np.random.choice(['grocery', 'gas_station', 'restaurant', 'retail'], n_samples),
            'transaction_type': np.random.choice(['purchase', 'withdrawal', 'transfer'], n_samples),
            'location': np.random.choice(['seattle_wa', 'portland_or', 'san_francisco_ca'], n_samples),
    ...
    def test_feature_engineer_creates_all_features(self, feature_engineer, sample_raw_data):
        ...
        expected_temporal_features = ['hour_of_day', 'day_of_week', 'is_weekend', 'is_business_hours']
    ...
    def test_serving_api_sample_transaction(self):
        ...
        required_fields = ['amount', 'merchant_category', 'transaction_type', 
