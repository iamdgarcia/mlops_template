...
def compare_with_production(
    new_metrics: Dict[str, float], production_baseline: Dict[str, Any], config: Dict[str, Any]
) -> Tuple[bool, List[str]]:
    ...
    critical_metrics = config.get("deployment", {}).get("critical_metrics", ["recall", "roc_auc"])
