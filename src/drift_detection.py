...
class DataDriftDetector:
    ...
    def __init__(self, reference_data: pd.DataFrame, selected_features: List[str], 
    ...
    def detect_numerical_drift(self, reference_col: pd.Series, current_col: pd.Series, 
        ...
        if isinstance(ks_p_value, (int, float)) and isinstance(self.significance_level, (int, float)):
    ...
    def detect_categorical_drift(self, reference_col: pd.Series, current_col: pd.Series, 
                               feature_name: str) -> Dict[str, Any]:
        ...
        if isinstance(chi2_p_value, (int, float)) and isinstance(self.significance_level, (int, float)):
    ...
    def _jensen_shannon_divergence(self, p_data: pd.Series, q_data: pd.Series, 
...
class ModelPerformanceDriftDetector:
    ...
    def __init__(self, model: Any, baseline_metrics: Dict[str, float], 
    ...
    def evaluate_model_performance(self, X: pd.DataFrame, y: pd.Series) -> Optional[Dict[str, float]]:
...
class DriftAlertSystem:
    ...
    def generate_alert_report(self, drift_result: Dict[str, Any], 
                            performance_result: Optional[Dict[str, Any]] = None, 
                            dataset_name: str = "Current Data") -> Dict[str, Any]:
...
def create_drifted_data(reference_data: pd.DataFrame, drift_type: str = 'moderate', 
