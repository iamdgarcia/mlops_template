...
class FraudDetectionAPITester:
    ...
    def test_performance(self, num_requests: int = 100) -> Dict:
        ...
        metrics = {
            ...
            "avg_processing_time_ms": total_processing_time / successful_requests if successful_requests > 0 else 0
        }
    ...
    def test_input_validation(self) -> List[Dict]:
        ...
        invalid_scenarios = [
            ...
            },
            {
                ...
                "transaction": self.create_test_transaction({"merchant_category": "invalid_category"}),
                "should_fail": True
            },
            {
                "name": "Invalid hour",
            ...
            },
            {
                ...
                "transaction": {k: v for k, v in self.create_test_transaction().items() if k != "amount"},
                "should_fail": True
            }
        ]
        ...
        for scenario in invalid_scenarios:
            ...
            try:
                ...
                if scenario['should_fail'] and response.status_code == 200:
                    ...
                    print(f"    [ERROR] Expected success but request failed: {response.status_code}")
                else:
